...
Board.prototype = {
    ...
    _getPieceArr: function (camp) {
        var ret = [];
        for (var piece in this._pos_piece) {
    ...
    _isNotFaced: function () {
        ...
        var y_low = this.redLeader.pos.y;
        var y_high = this.blackLeader.pos.y;
        for (var y = y_low + 1; y < y_high; y++)
    ...
    addPiece: function (piece) {
        var pos = piece.pos;
        if (this.getPiece(pos)) throw Error('already exist ' + pos.toString());
